...
/* Public methods */
    ...
    function insert($order_status = DEFAULT_ORDERS_STATUS_ID) {
      ...
      $Qstatus->bindInt(':sms_customer_notified', '0');
    ...
    function insertOrderStatusHistory($orders_id, $orders_status, $comments) {
      ...
      $Qinsert = $osC_Database->query('insert into :table_orders_status_history (orders_id, orders_status_id, date_added, customer_notified, sms_customer_notified, comments) values (:orders_id, :orders_status_id, now(), :customer_notified, :sms_customer_notified, :comments)');
      ...
      $Qinsert->bindInt(':sms_customer_notified', (SEND_SMS_NEW_OREDER_TO_USER == '1') ? '1' : '0');
