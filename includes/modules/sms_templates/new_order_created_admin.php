<?php
/*
  $Id: new_order_created_admin.php $
...
*/
  ...
  class toC_Sms_Template_new_order_created_admin extends toC_Sms_Template {

/* Private variables */

    var $_template_name = 'new_order_created_admin',
...
/* Class constructor */
    ...
    function toC_Sms_Template_new_order_created_admin() {
  ...
  function setData($order_id){
    ...
    global $osC_Database, $osC_Language, $osC_Currencies;
      ...
      if ($Qorder->numberOfRows() === 1) {
        ...
        $telephone = $Qorder->value('billing_telephone');
        ...
        $replaces = array($order_number, $date_ordered, $telephone, $payment_method, $order_status, STORE_NAME);
