  ...
  class toC_Json_Orders {
    ...
    function listOrdersStatus(){
      ...
      $records[] = array('date_added' => osC_DateTime::getShort($status_history['date_added'], true),
                         ...
                         'sms_customer_notified' => osc_icon((($status_history['sms_customer_notified'] === 1) ? 'checkbox_ticked.gif' : 'checkbox_crossed.gif')));
      }
    ...
    function updateOrdersStatus() {
      ...
      $data = array( 'status_id' =>  $_REQUEST['status'],
                     ...
                     'sms_notify_customer' => ( isset($_REQUEST['sms_notify_customer']) && ( $_REQUEST['sms_notify_customer'] == 'on') ? true : false ),
