  ...
  getOrdersStatusGrid: function(ordersId) {
    grdOrdersStatus = new Ext.grid.GridPanel({
      ...
      cm: new Ext.grid.ColumnModel([
        ...
        {header: '<?php echo $osC_Language->get('table_heading_sms_customer_notified');?>', dataIndex: 'sms_customer_notified', width: 120, align: 'center'}
      ]),
  ...
  getOrdersStatusForm: function(ordersId) {
    ...
    this.frmOrdersStatus = new Ext.form.FormPanel({
      ...
      items: [
        ...
        {xtype: 'checkbox', fieldLabel: '<?php echo $osC_Language->get('field_sms_notify_customer'); ?>', name: 'sms_notify_customer'},
